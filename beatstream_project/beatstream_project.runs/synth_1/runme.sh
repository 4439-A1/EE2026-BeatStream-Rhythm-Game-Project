...
HD_PWD='C:/Users/43lan/Downloads/S1_20_KIM GYURIM_SARAVANAN SWETHA_YOSHIZAKI EICHI_ZHONG SHU_Improvements_Archive.xpr/beatstream_project/beatstream_project.runs/synth_1'
cd "$HD_PWD"
